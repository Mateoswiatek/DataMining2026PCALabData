...
|---|---:|---:|
| Mediana [min] | 173.1 | 175.3 |
| Średnia [min] | ~300 | 331.0 |
| P95 [min] | ~850 | 1 148.5 |

Symulacja odtwarza medianę z dokładnością **1.3%**. Rozkład jest prawostronnie skośny — większość przypadków kończy się w 100–300 min, ale długi ogon (overnight) przesuwa średnią do ~330 min.

Symulacja niedoszacowuje P95 (~850 vs 1148 min) — wynika to z rzadkiego samplo­wania ekstremalnych zdarzeń overnight (n<30 takich przejść w logu). Model symulacyjny jest dobry do planowania normalnego przepływu, ale niedokładny dla ekstremów.
